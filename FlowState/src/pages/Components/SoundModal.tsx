...
const SoundModal: React.FC<SoundGeneratorUIProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'generate' | 'mySounds'>('generate');
  const [isCollapsed, setIsCollapsed] = useState(false);
  const [savedSounds, setSavedSounds] = useState<GeneratedSound[]>([
    {
      id: '1',
  ...
  const togglePlayPause = (soundId: string) => {
    ...
    setSavedSounds(prev =>
      prev.map(s => ({
        ...s,
        isPlaying: s.id === soundId ? !s.isPlaying : false,
      }))
    );
    ...
    if (shouldPlay) {
      ...
      audio.onended = () => {
        setSavedSounds(prev =>
          prev.map(s => s.id === soundId ? { ...s, isPlaying: false } : s)
        );
      };
      setCurrentAudio(audio);
    } else {
      if (currentAudio && currentAudio.src === sound.audioUrl) {
        currentAudio.pause();
      }
    }
  };
          ...
          {activeTab === 'generate' ? (
            ...
            <div className="mySoundsContent">
                <div className="soundsGrid">
                    ...
                    <SessionAudioCard image='/images/rain.svg'
                    name='Rainy Day'
        ...
        <div className="rightControls">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
              <path d="M25.6665 10.5001V8.16675H24.4998V5.83341H23.3332V4.66675H22.1665V3.50008H19.8332V2.33341H17.4998V1.16675H10.4998V2.33341H8.1665V3.50008H5.83317V4.66675H4.6665V5.83341H3.49984V8.16675H2.33317V10.5001H1.1665V17.5001H2.33317V19.8334H3.49984V22.1667H4.6665V23.3334H5.83317V24.5001H8.1665V25.6667H10.4998V26.8334H17.4998V25.6667H19.8332V24.5001H22.1665V23.3334H23.3332V22.1667H24.4998V19.8334H25.6665V17.5001H26.8332V10.5001H25.6665ZM24.4998 17.5001H23.3332V19.8334H22.1665V22.1667H19.8332V23.3334H17.4998V24.5001H10.4998V23.3334H8.1665V22.1667H5.83317V19.8334H4.6665V17.5001H3.49984V10.5001H4.6665V8.16675H5.83317V5.83341H8.1665V4.66675H10.4998V3.50008H17.4998V4.66675H19.8332V5.83341H22.1665V8.16675H23.3332V10.5001H24.4998V17.5001Z" fill="black"/>
              <path d="M18.6668 17.4999V18.6666H17.5002V19.8333H16.3335V18.6666H15.1668V17.4999H14.0002V16.3333H12.8335V5.83325H15.1668V15.1666H16.3335V16.3333H17.5002V17.4999H18.6668Z" fill="black"/>
            </svg>
          </button>
          <button
            className="iconButton"
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
              <path d="M0 21.75V15.7083H2.41667V19.3333H6.04167V21.75H0ZM15.7083 21.75V19.3333H19.3333V15.7083H21.75V21.75H15.7083ZM0 6.04167V0H6.04167V2.41667H2.41667V6.04167H0ZM19.3333 6.04167V2.41667H15.7083V0H21.75V6.04167H19.3333Z" fill="black"/>
            </svg>          
          </button>
          <button
            className="iconButton"
