import styles from "./RainforestSession.module.css";
...
const RainforestSession: React.FC = () => {
  ...
  return (
    <>
      <div className={styles.sessionContainer} data-theme="rainforest">
...
export default RainforestSession;